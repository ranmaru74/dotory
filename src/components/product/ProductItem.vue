	...
	<div class="mb-3 col-sm-6 col-md-4 item" :class="{'list-group-item': displayList}">
		<div class="thumbnail card">
			<div class="img-event intrinsic">
				<img :src="require(`@/assets/images/${item.thumbnail_url}.png`)" alt=""
				     class="grow thumbnail-image card-img-top intrinsic-item p-3">
			</div>
			<div class="card-body">
				<router-link :to="'/product/' + item.id" tag="h5" class="card-title"><a>{{ item.title }}</a>
				</router-link>
				...
				<div class="row">
					<p class="col-6 lead">{{ item.price }} IDT</p>
					<p class="col-6">
